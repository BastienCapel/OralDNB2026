...
function generateEleveHTML(item) {
    ...
    <div class="print-page print-card">
        ...
        <div class="print-body">
            ...
            <p class="mb-6">Est convoqué(e) pour présenter l'épreuve orale du Diplôme National du Brevet concernant le domaine suivant :</p>
            ...
            <div class="grid-2-cols mb-6">
                <div class="highlight-box">
                    <p class="info-label text-primary">Heure de passage</p>
                    <p class="text-2xl font-bold">${item.heure}</p>
